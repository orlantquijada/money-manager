...
1. Read the target component code
2. Identify ONE improvement - the single most impactful change
3. Implement it
4. Repeat
...
- Don't undo previous good changes
- Stop if no clear improvement identified
